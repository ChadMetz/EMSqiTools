#' summary_table
#'
#' Generates a monthly summary table based on plot type.
#'
#' @param df A dataframe used for plotting.
#' @param date_col Date column (string).
#' @param numerator_col Column for numerator condition (string).
#' @param denominator_col Column for denominator condition (string).
#' @param numerator_value Value for numerator matching (e.g., 1).
#' @param plot_type One of 'spc', 'count', 'average'.
#' @param time_col Optional. Column containing time values (for averages).
#' @param start_date Start date for summary window.
#' @param end_date End date for summary window.
#'
#' @return A gt summary table (monthly breakdown).
#'
