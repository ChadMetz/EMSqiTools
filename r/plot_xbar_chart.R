#' plot_xbar_chart
#'
#' X-Bar Chart with annotations, using time-based subgroup means.
#'
#' @param df Dataframe.
#' @param date_col Column name (string) for date/time.
#' @param id_col Unique identifier column (string).
#' @param value_col Column of numeric values (string).
...
#'
#' @return A summary dataframe and displays the X-bar chart.
#'
