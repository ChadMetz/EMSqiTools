#' plot_imr_chart
#'
#' I-MR Chart with annotations: individuals and moving range over time.
#'
#' @param df Dataframe.
#' @param date_col Column name (string) for date/time.
#' @param id_col Unique identifier column (string).
#' @param value_col Numeric value column (string).
...
#'
#' @return A list of ggplot2 objects: I Chart and MR Chart.
#'
