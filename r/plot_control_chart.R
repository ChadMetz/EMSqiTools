#' plot_control_chart
#'
#' Create a statistical process control (SPC) chart with annotations and segmented control limits.
#'
...
#'
#' @return A summary dataframe and displays the control chart.
#'
#' @import ggplot2, dplyr, lubridate, scales, grid, rlang
#' @examples
